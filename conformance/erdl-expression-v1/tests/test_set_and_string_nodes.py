...
def test_a_non_string_operand_is_a_type_mismatch() -> None:
    assert_errored({"contains": [{"field": "cmd"}, 123]}, {"cmd": "rm"}, "type_mismatch")
    assert_errored({"starts_with": [{"field": "n"}, 1]}, {"n": "safe"}, "type_mismatch")
