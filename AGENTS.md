...
**Concordia** is a Python SDK and MCP server (~14,000 lines of code across `concordia/`, 59 tools exposed via FastMCP) implementing a structured multi-attribute negotiation protocol for autonomous agents. Version 0.8.0 (current published release).
