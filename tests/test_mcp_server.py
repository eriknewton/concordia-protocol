...
Covers all 25 MCP tools, session lifecycle flows, error handling,
...
class TestSdkIntegration:
    ...
    def test_tools_registered_with_sdk(self):
        """All 25 tools are registered with the FastMCP tool manager."""
...
class TestToolDefinitions:
    ...
    def test_tool_count(self):
        assert len(get_tool_definitions()) == 25
