...
Covers all 35 MCP tools, session lifecycle flows, error handling,
...
class TestSdkIntegration:
    ...
    def test_tools_registered_with_sdk(self):
        """All 35 tools are registered with the FastMCP tool manager."""
...
class TestToolDefinitions:
    ...
    def test_tool_count(self):
        assert len(get_tool_definitions()) == 35
